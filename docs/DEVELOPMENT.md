...
How Gabbro gets built, signed and onto a phone. The product README is
[`../README.md`](../README.md); the operational traps live in
[`M0-RUNBOOK.md`](M0-RUNBOOK.md).

This exists because the whole project is developed on **Windows**, with no Mac
anywhere in the loop. Most of what follows is a consequence of that.
